...
activate_plot_trendPreservation = True
...
# ####################  absolute units, limits and cmap    #####################################################
absolute_units_and_palette = {
    'tasmax_TXm': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_TX90p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmax_TX99p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmax_TX95p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmax_TX10p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmax_TX1p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmax_TX5p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmax_TXx': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_TXn': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_p99': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_p95': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_p90': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_p10': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_p5': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_p1': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_SU': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmax_ID': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmax_WSDI': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},

    'tasmin_TNm': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_TN90p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmin_TN99p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmin_TN95p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmin_TN10p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmin_TN5p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmin_TN1p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmin_TNx': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_TNn': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_p99': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_p95': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_p90': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_p10': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_p5': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_p1': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_FD': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmin_TR': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tasmin_CSDI': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},

    'tas_Tm': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tas_T90p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tas_T99p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tas_T95p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tas_T10p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tas_T5p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tas_T1p': {'units': 'days', 'vmin': -20, 'vmax': 20, 'cmap': 'jet'},
    'tas_Tx': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tas_Tn': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tas_p99': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tas_p95': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tas_p90': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tas_p10': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tas_p5': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},
    'tas_p1': {'units': degree_sign, 'vmin': -20, 'vmax': 50, 'cmap': 'jet'},

    'pr_Pm': {'units': 'mm', 'vmin': 0, 'vmax': 800, 'cmap': 'brbg'},
    'pr_PRCPTOT': {'units': 'mm', 'vmin': 0, 'vmax': 800, 'cmap': 'brbg'},
    'pr_R01': {'units': 'days', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'pr_SDII': {'units': 'mm', 'vmin': 0, 'vmax': 800, 'cmap': 'brbg'},
    'pr_Rx1day': {'units': 'mm', 'vmin': 0, 'vmax': 800, 'cmap': 'brbg'},
    'pr_Rx5day': {'units': 'mm', 'vmin': 0, 'vmax': 800, 'cmap': 'brbg'},
    'pr_R10mm': {'units': 'days', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'pr_R20mm': {'units': 'days', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'pr_CDD': {'units': 'days', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'pr_p95': {'units': 'mm', 'vmin': 0, 'vmax': 800, 'cmap': 'brbg'},
    'pr_R95p': {'units': 'mm', 'vmin': 0, 'vmax': 800, 'cmap': 'brbg'},
    'pr_R95pFRAC': {'units': 'mm', 'vmin': 0, 'vmax': 800, 'cmap': 'brbg'},
    'pr_p99': {'units': 'mm', 'vmin': 0, 'vmax': 800, 'cmap': 'brbg'},
    'pr_R99p': {'units': 'mm', 'vmin': 0, 'vmax': 800, 'cmap': 'brbg'},
    'pr_R99pFRAC': {'units': 'mm', 'vmin': 0, 'vmax': 800, 'cmap': 'brbg'},
    'pr_CWD': {'units': 'days', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},

    'uas_Um': {'units': 'm/s', 'vmin': -50, 'vmax': 50, 'cmap': 'viridis'},
    'uas_Ux': {'units': 'm/s', 'vmin': -50, 'vmax': 50, 'cmap': 'viridis'},

    'vas_Vm': {'units': 'm/s', 'vmin': -50, 'vmax': 50, 'cmap': 'viridis'},
    'vas_Vx': {'units': 'm/s', 'vmin': -50, 'vmax': 50, 'cmap': 'viridis'},

    'sfcWind_SFCWINDm': {'units': 'm/s', 'vmin': 0, 'vmax': 50, 'cmap': 'viridis'},
    'sfcWind_SFCWINDx': {'units': 'm/s', 'vmin': 0, 'vmax': 50, 'cmap': 'viridis'},

    'hurs_HRm': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'hurs_p99': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'hurs_p95': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'hurs_p90': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'hurs_p10': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'hurs_p5': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'hurs_p1': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},

    'huss_HUSSm': {'units': '', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'huss_HUSSx': {'units': '', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'huss_HUSSn': {'units': '', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'huss_p99': {'units': '', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'huss_p95': {'units': '', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'huss_p90': {'units': '', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'huss_p10': {'units': '', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'huss_p5': {'units': '', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},
    'huss_p1': {'units': '', 'vmin': 0, 'vmax': 100, 'cmap': 'brbg'},

    'clt_CLTm': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'viridis'},
    'clt_p99': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'viridis'},
    'clt_p95': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'viridis'},
    'clt_p90': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'viridis'},
    'clt_p10': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'viridis'},
    'clt_p5': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'viridis'},
    'clt_p1': {'units': '%', 'vmin': 0, 'vmax': 100, 'cmap': 'viridis'},

    'rsds_RSDSm': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rsds_RSDSx': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rsds_RSDSn': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rsds_p99': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rsds_p95': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rsds_p90': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rsds_p10': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rsds_p5': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rsds_p1': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},

    'rlds_RLDSm': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rlds_RLDSx': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rlds_RLDSn': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rlds_p99': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rlds_p95': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rlds_p90': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rlds_p10': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rlds_p5': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'rlds_p1': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},

    'e_Em': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'e_Ex': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'e_En': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'e_p99': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'e_p95': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'e_p90': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'e_p10': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'e_p5': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'e_p1': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},

    'ep_EPm': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ep_EPx': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ep_EPn': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ep_p99': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ep_p95': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ep_p90': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ep_p10': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ep_p5': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ep_p1': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},

    'psl_PSLm': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'psl_PSLx': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'psl_PSLn': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'psl_p99': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'psl_p95': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'psl_p90': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'psl_p10': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'psl_p5': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'psl_p1': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},

    'ps_PSm': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ps_PSx': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ps_PSn': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ps_p99': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ps_p95': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ps_p90': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ps_p10': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ps_p5': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'ps_p1': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},

    'mrro_RUNOFFm': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrro_RUNOFFx': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrro_RUNOFFn': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrro_p99': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrro_p95': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrro_p90': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrro_p10': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrro_p5': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrro_p1': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},

    'mrso_SOILMOISTUREm': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrso_SOILMOISTUREx': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrso_SOILMOISTUREn': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrso_p99': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrso_p95': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrso_p90': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrso_p10': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrso_p5': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
    'mrso_p1': {'units': '', 'vmin': -100, 'vmax': 100, 'cmap': 'viridis'},
}

# ####################  CLIMDEX AND BIAS MODE    #####################################################
bias_units_and_palette = {
    'tasmax_TXm': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmax_TX90p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_TX99p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_TX95p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_TX10p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_TX1p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_TX5p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_TXx': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmax_TXn': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmax_p99': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmax_p95': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmax_p90': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmax_p10': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmax_p5': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmax_p1': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmax_SU': {'biasMode': 'rel', 'units': 'days', 'vmin': -100, 'vmax': 100, 'cmap': 'jet'},
    'tasmax_ID': {'biasMode': 'rel', 'units': 'days', 'vmin': -100, 'vmax': 100, 'cmap': 'jet'},
    'tasmax_WSDI': {'biasMode': 'rel', 'units': 'days', 'vmin': -100, 'vmax': 100, 'cmap': 'jet'},

    'tasmin_TNm': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmin_TN90p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_TN99p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_TN95p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_TN10p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_TN5p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_TN1p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_TNx': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmin_TNn': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmin_p99': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmin_p95': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmin_p90': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmin_p10': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmin_p5': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmin_p1': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tasmin_FD': {'biasMode': 'rel', 'units': 'days', 'vmin': -100, 'vmax': 100, 'cmap': 'jet'},
    'tasmin_TR': {'biasMode': 'rel', 'units': 'days', 'vmin': -100, 'vmax': 100, 'cmap': 'jet'},
    'tasmin_CSDI': {'biasMode': 'rel', 'units': 'days', 'vmin': -100, 'vmax': 100, 'cmap': 'jet'},

    'tas_Tm': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tas_T90p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tas_T99p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tas_T95p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tas_T10p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tas_T5p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tas_T1p': {'biasMode': 'abs', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tas_Tx': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tas_Tn': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tas_p99': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tas_p95': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tas_p90': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tas_p10': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tas_p5': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},
    'tas_p1': {'biasMode': 'abs', 'units': degree_sign, 'vmin': -10, 'vmax': 10, 'cmap': 'jet'},

    'pr_Pm': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_PRCPTOT': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_R01': {'biasMode': 'rel', 'units': 'days', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_SDII': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_Rx1day': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_Rx5day': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_R10mm': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_R20mm': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_CDD': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_R95p': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_R95pFRAC': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_R99p': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_R99pFRAC': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'pr_CWD': {'biasMode': 'rel', 'units': 'days', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},

    'uas_Um': {'biasMode': 'abs', 'units': 'm/s', 'vmin': -10, 'vmax': 10, 'cmap': 'prgn'},
    'uas_Ux': {'biasMode': 'abs', 'units': 'm/s', 'vmin': -10, 'vmax': 10, 'cmap': 'prgn'},

    'vas_Vm': {'biasMode': 'abs', 'units': 'm/s', 'vmin': -10, 'vmax': 10, 'cmap': 'prgn'},
    'vas_Vx': {'biasMode': 'abs', 'units': 'm/s', 'vmin': -10, 'vmax': 10, 'cmap': 'prgn'},

    'sfcWind_SFCWINDm': {'biasMode': 'rel', 'units': 'm/s', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'sfcWind_SFCWINDx': {'biasMode': 'rel', 'units': 'm/s', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},

    'hurs_HRm': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'hurs_p99': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'hurs_p95': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'hurs_p90': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'hurs_p10': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'hurs_p5': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'hurs_p1': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},

    'huss_HUSSm': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'huss_HUSSx': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'huss_HUSSn': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'huss_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'huss_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'huss_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'huss_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'huss_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},
    'huss_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'brbg'},

    'clt_CLTm': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'clt_p99': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'clt_p95': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'clt_p90': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'clt_p10': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'clt_p5': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'clt_p1': {'biasMode': 'abs', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},

    'rsds_RSDSm': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rsds_RSDSx': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rsds_RSDSn': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rsds_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rsds_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rsds_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rsds_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rsds_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rsds_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},

    'rlds_RLDSm': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rlds_RLDSx': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rlds_RLDSn': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rlds_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rlds_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rlds_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rlds_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rlds_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'rlds_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},

    'e_Em': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'e_Ex': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'e_En': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'e_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'e_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'e_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'e_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'e_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'e_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},

    'ep_EPm': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ep_EPx': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ep_EPn': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ep_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ep_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ep_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ep_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ep_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ep_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},

    'psl_PSLm': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'psl_PSLx': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'psl_PSLn': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'psl_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'psl_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'psl_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'psl_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'psl_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'psl_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},

    'ps_PSm': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ps_PSx': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ps_PSn': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ps_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ps_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ps_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ps_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ps_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'ps_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},

    'mrro_RUNOFFm': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrro_RUNOFFx': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrro_RUNOFFn': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrro_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrro_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrro_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrro_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrro_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrro_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},

    'mrso_SOILMOISTUREm': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrso_SOILMOISTUREx': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrso_SOILMOISTUREn': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrso_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrso_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrso_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrso_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrso_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
    'mrso_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'},
}
if myTargetVar in targetVars:
    ...
    for climdex in climdex_names[myTargetVar]:
        if climdex[-1] == 'p':
            ...
            newUnits = units
        bias_units_and_palette.update({myTargetVar + '_' + climdex: {'biasMode': biasMode, 'units': newUnits, 'vmin': -100, 'vmax': 100, 'cmap': 'prgn'}})
