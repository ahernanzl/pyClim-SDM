...
absolute_units_and_palette = {
    ...
    'pr_Pm': {'units': 'mm', 'vmin': 0, 'vmax': 3, 'cmap': 'brbg'},
...
bias_units_and_palette = {
    ...
    'tasmax_SU': {'biasMode': 'rel', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_ID': {'biasMode': 'rel', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmax_WSDI': {'biasMode': 'rel', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    ...
    'tasmin_FD': {'biasMode': 'rel', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_TR': {'biasMode': 'rel', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    'tasmin_CSDI': {'biasMode': 'rel', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'jet'},
    ...
    'pr_Pm': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_PRCPTOT': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_R01': {'biasMode': 'rel', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_SDII': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_Rx1day': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_Rx5day': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_R10mm': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_R20mm': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_CDD': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_R95p': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_R95pFRAC': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_R99p': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_R99pFRAC': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'pr_CWD': {'biasMode': 'rel', 'units': 'days', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    ...
    'sfcWind_SFCWINDm': {'biasMode': 'rel', 'units': 'm/s', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'sfcWind_SFCWINDx': {'biasMode': 'rel', 'units': 'm/s', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},

    'hurs_HRm': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'hurs_p99': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'hurs_p95': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'hurs_p90': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'hurs_p10': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'hurs_p5': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'hurs_p1': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},

    'huss_HUSSm': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'huss_HUSSx': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'huss_HUSSn': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'huss_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'huss_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'huss_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'huss_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'huss_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},
    'huss_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'brbg'},

    'clt_CLTm': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'clt_p99': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'clt_p95': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'clt_p90': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'clt_p10': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'clt_p5': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'clt_p1': {'biasMode': 'abs', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},

    'rsds_RSDSm': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rsds_RSDSx': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rsds_RSDSn': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rsds_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rsds_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rsds_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rsds_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rsds_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rsds_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},

    'rlds_RLDSm': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rlds_RLDSx': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rlds_RLDSn': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rlds_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rlds_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rlds_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rlds_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rlds_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'rlds_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},

    'e_Em': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'e_Ex': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'e_En': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'e_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'e_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'e_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'e_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'e_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'e_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},

    'ep_EPm': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ep_EPx': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ep_EPn': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ep_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ep_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ep_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ep_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ep_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ep_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},

    'psl_PSLm': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'psl_PSLx': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'psl_PSLn': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'psl_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'psl_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'psl_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'psl_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'psl_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'psl_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},

    'ps_PSm': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ps_PSx': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ps_PSn': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ps_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ps_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ps_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ps_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ps_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'ps_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},

    'mrro_RUNOFFm': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrro_RUNOFFx': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrro_RUNOFFn': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrro_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrro_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrro_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrro_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrro_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrro_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},

    'mrso_SOILMOISTUREm': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrso_SOILMOISTUREx': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrso_SOILMOISTUREn': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrso_p99': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrso_p95': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrso_p90': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrso_p10': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrso_p5': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
    'mrso_p1': {'biasMode': 'rel', 'units': '%', 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'},
}
if myTargetVar in targetVars:
    ...
    for climdex in climdex_names[myTargetVar]:
        if climdex[-1] == 'p':
            ...
            newUnits = units
        bias_units_and_palette.update({myTargetVar + '_' + climdex: {'biasMode': biasMode, 'units': newUnits, 'vmin': -50, 'vmax': 50, 'cmap': 'prgn'}})
