...
class welcomeMessage(ttk.Frame):
    ...
    def __init__(self):
        if showWelcomeMessage == True:
            ...
            if (screen_width < rootW) or (screen_height < rootH):
                print('Your screen resolution is too small. ')
                print('Please change your screen resolution to the minimum required resolution: w=1280 and h=620.')
                print(
            ...
            frameLogo.grid(column=0, row=0, padx=240)
            ...
            # frameMsg
            frameMsg = Frame(root)
            frameMsg.grid(sticky="W", column=0, row=1, padx=300, pady=0)
