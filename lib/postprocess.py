...
#         scene_bc = MOS_lib.biasCorrect_as_postprocess(obs, mod, sce, targetVar, obs_times[idates_ref], est_times[idates_sce])
#
#         # Save results year
...
#
#         # Correct bias for year
#         scene_bc[idates_sce] = MOS_lib.biasCorrect_as_postprocess(obs, mod, sce, targetVar, obs_times_fold, est_times_fold)
#
#     # Set units
#     units = predictands_units[targetVar]
#
